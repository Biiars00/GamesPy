...
def jogar():
    ...
    mensagem_abertura()
    palavra_secreta = criando_palavra_secreta()
...
def mensagem_abertura():
    print("Vamos jogar?")
    print("Este é um jogo da forca, tente descobrir a palavra. Boa sorte!")

def criando_palavra_secreta():
...
def mensagem_perdedor(palavra_secreta):
    print("Sinto muito, você foi enforcado!")
